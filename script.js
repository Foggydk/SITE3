...
.loader-square {
    ...
    animation: loaderSquare 1.2s infinite ease-in-out;
}
...
.testimonials {
    ...
    .testimonials::before {
        ...
        width: 100%;
        height: 100%;
        background-image: url('https://images.unsplash.com/photo-1513584684374-8bab748fbf90?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80');
...
.btn-submit i:last-of-type {
    margin-left: 10px;
    transition: transform var(--transition-normal);
}

.btn-submit:hover i:last-of-type {
    transform: translateX(5px);
}
...
.btn-submit.loading i:last-of-type {
    opacity: 0;
}
...
/* ===== FIX FOR RUSSIAN TEXT ENCODING ===== */
@charset "UTF-8";

/* Ensure all text elements use proper font with Cyrillic support */
body, .form-input, .form-select, .form-textarea, button, input, textarea {
